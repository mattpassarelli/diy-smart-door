 ...
 * Add system "stoppage" on WiFi disconnect - DONE
 * Connect System to Home Assistant
 * Trigger Commands via HA
 * Add Power on/off commands to beginning and end of servo functions after transistors arrive 
*/
...
void setup() {
    ...
    //TODO: Add unlock and open button
